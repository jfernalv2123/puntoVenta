...
public class ProveedorBean {
	...
	private List<Proveedor> listaProveedorAux;
	...
	public List<Proveedor> getListaProveedorAux() {
		return listaProveedorAux;
	}

	public void setListaProveedorAux(List<Proveedor> listaProveedorAux) {
		this.listaProveedorAux = listaProveedorAux;
	}
	...
	public void modificar(Proveedor pT){
		proveedorAux=pT;
	}
	...
	public void guardarFono(Proveedor proveedor){
		Fono fono = new Fono();
		fono.setProveedor(proveedorService.findProveedorById(proveedor.getIdProveedor()));
	...
	public void guardarMail(Proveedor proveedor){
		Mail mail = new Mail();
		mail.setProveedor(proveedorService.findProveedorById(proveedor.getIdProveedor()));
	...
	public void guardarDireccion(Proveedor proveedor){
		...
		direccion.setProveedor(proveedorService.findProveedorById(proveedor.getIdProveedor()));
	...
	public void asignarIdProveedor(int id){
		this.id=id;
	}
	public List<SelectItem> comboRazonSocial(){
		List<SelectItem> aux=razonSocialService.comboRazonSocial();
		SelectItem sele=new SelectItem();
		sele.setLabel(String.valueOf("Seleccione"));
		sele.setValue(String.valueOf(""));
		aux.add(sele);
		return aux;
	}
	public List<SelectItem> siNo(){
		...
		sele.setValue(String.valueOf(""));
		aux.add(sele);
		SelectItem seleSi=new SelectItem();
		seleSi.setLabel(String.valueOf("Si"));
		seleSi.setValue(String.valueOf("true"));
		aux.add(seleSi);
		SelectItem seleN=new SelectItem();
		seleN.setLabel(String.valueOf("No"));
		seleN.setValue(String.valueOf("false"));
		aux.add(seleN);
		return aux;
	}
}
